...
CASSANDRA_AUTHENTICATOR="${CASSANDRA_AUTHENTICATOR:-AllowAllAuthenticator}"
CASSANDRA_ROLES_VALIDITY_IN_MS="${CASSANDRA_ROLES_VALIDITY_IN_MS:-2000}"
CASSANDRA_CREDENTIALS_VALIDITY_IN_MS="${CASSANDRA_CREDENTIALS_VALIDITY_IN_MS:-2000}"
...
echo CASSANDRA_AUTHENTICATOR ${CASSANDRA_AUTHENTICATOR}
echo CASSANDRA_ROLES_VALIDITY_IN_MS ${CASSANDRA_ROLES_VALIDITY_IN_MS}
echo CASSANDRA_CREDENTIALS_VALIDITY_IN_MS ${CASSANDRA_CREDENTIALS_VALIDITY_IN_MS}
